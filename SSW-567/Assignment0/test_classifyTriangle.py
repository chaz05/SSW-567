...
class Test(unittest.TestCase):
    ...
    def testNominalScalene(self):
        for member in [Tony, Travis]:     
            self.assertEqual(member.classifyTriangle(3, 4, 5, 0), (True, False, False, True))
            
            self.assertEqual(member.classifyTriangle(1, 2, 3), (True, False, False, False))
    ...
    def testNominalIsosceles(self):
        for member in [Tony, Travis]:
            ...
            #not right
            self.assertEqual(member.classifyTriangle(2, 2, 5), (False, True, False, False))
    ...
    def testInvalidInputs(self):
        for member in [Tony, Travis]:
            ...
            self.assertEqual(member.classifyTriangle(-1, 2, 5), (True, False, False, False))
